...
class TestOpenRouterPresetsIntegration(unittest.TestCase):
    ...
    def test_preset_lookup_and_resolution(self):
        ...
        # Resolve model with preset as override name
    ...
    def test_preset_validation_guard(self):
        # Without preset, a canonical key or unknown model might be checked
        # Now test adding a preset and checking _model_rejected_reason with manager using default dir
