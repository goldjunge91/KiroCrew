...
class TestInlinePayloadNamesTheMintSurface:
    ...
    def test_an_unterminated_loader_call_fails_closed(self):
        # A parenthesis inside a string literal skews the depth and ends the scan early. The
        # slice that comes back is LONGER, so the reading denies rather than allows.
