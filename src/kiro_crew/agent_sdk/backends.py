...
#
# Read rather than hard-coded at every site that asks. All seven: the levels parsers
# in ``acp/client.py`` and ``acp/session_handle.py``; the advertised-option check plus
# the two pushes in ``providers/acp.py``; and the support probe plus the push in
