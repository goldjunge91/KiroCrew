    ...
    return [
        ...
        },
        {
            ...
            "description": (
                ...
                "tool rejects recognized runtime identity assertions and model-selection "
                "imperatives whose selected object is a concrete model ID at the end "
                "of its clause in the rule or negative clause. Clause endings are the "
                "field end, a newline, punctuation, or the documented closed connector "
                "class. A following plain noun makes the ID a durable tooling qualifier. "
