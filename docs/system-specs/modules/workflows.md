...
consumed. Both paths depend on adapters cooperating with cancellation; they do
...
initialization failure, never on slowness or cancellation. Ordinary standalone
