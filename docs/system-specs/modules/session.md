...
`session_capabilities.runtime_view(manager, member, saved_revision)` reads actual
registry occupants on the event loop. Old live sessions report pending and keep
