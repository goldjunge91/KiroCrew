...
|---|---|---|
| [rfc-org-chart-and-guardrails.md](rfc-org-chart-and-guardrails.md) | `draft` | Executable prototype for persistent organization members, fixed role limits, bounded hiring, chat-originated assignments and explicit review. The owning runtime contract is `system-specs/modules/crew-mode.md`. |
