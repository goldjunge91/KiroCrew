      ...
      {generating
        ...
        : (
          <Btn
            ...
            className="shrink-0 flex items-center gap-1 text-muted opacity-0 group-hover/header:opacity-40 hover:!opacity-100 hover:text-accent transition-all cursor-pointer bg-transparent border-none p-0"
          ...
          >
            ...
            {/* The glyph alone reads as an unexplained sparkle next to the
                composer's; the hover-revealed state names the action. */}
